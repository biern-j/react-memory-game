...
export const MemoryGame = ({onNewGame, onGameRestart, gameInfo, onSetToggle, onSetGameEnd, onHandleNewGame}: MemoryGameType) => 
    <MemoryGameView>
          {gameInfo.cards.length !== 0 && onSetGameEnd(gameInfo.cards) ?  <GameSummary
          ...
          onGameRestart={onGameRestart}
            ...
            /> }
          <Cards
          dificulty={gameInfo.gameDiffculty.find(level => level.choosen)!.multiple * gameInfo.players.length * 2}
